        ...
        componentDidMount() {
          this.scrollToHash(),
            n.isSsr &&
              ...
              (a.isFallback ||
                (a.nextExport &&
                  (E.isDynamicRoute(n.pathname) || location.search || W)) ||
          ...
          i
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                en(y({}, e, { err: l, Component: s, styleSheets: u, props: t }))
              );
            })
        );
      }
          ...
          window.__NEXT_PRELOADREADY &&
            ...
            (t.router = n =
              T.createRouter(a.page, a.query, o, {
                ...
                subscription: (e, t, r) =>
                  ea(Object.assign({}, e, { App: t, scroll: r })),
                locale: a.locale,
                locales: a.locales,
                defaultLocale: p,
      ...
      (t.default = class {
        ...
        getDataHref(e) {
          let { asPath: t, href: r, locale: n } = e,
            { pathname: d, query: f, search: h } = u.parseRelativeUrl(r),
            { pathname: p } = u.parseRelativeUrl(t),
        ...
        try {
          ...
          if (g.isDynamicRoute(d.pathname) && d.searchParams && r) {
            let h = v.searchParamsToUrlQuery(d.searchParams),
              { result: p, params: y } = B(d.pathname, d.pathname, h);
            p &&
                    ...
                    if (
                      ...
                      let p = S.parsePath(e),
                        m = R.formatNextPathnameInfo(
                          a(
                            {},
                            O.getNextPathnameInfo(p.pathname, {
                              nextConfig: n,
                              parseData: !0,
                            }),
                            {
      ...
      class Y {
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            ...
            l._inFlightRoute &&
              l.clc &&
              (R || Y.events.emit("routeChangeError", L(), l._inFlightRoute, H),
              l.clc(),
              (l.clc = null)),
              (r = C.addBasePath(
                w.addLocale(
            ...
            if (!h && l.onlyAHashChange(q) && !Z) {
              ...
              try {
                ...
                throw (
                  (d.default(z) &&
                    z.cancelled &&
                    Y.events.emit("routeChangeError", z, q, H),
                  z)
                );
              }
            ...
            let Q = s.removeTrailingSlash(V),
              ...
              er = yield T({ asPath: r, locale: v.locale, router: l });
            if (
            ...
            h || Y.events.emit("routeChangeStart", r, H);
            try {
              var ec, ed, ef, eh;
              ...
              if ("route" in ep && er) {
                (Q = V = ep.route || Q),
                  H.shallow || ($ = Object.assign({}, ep.query || {}, $));
                let em = j.hasBasePath(G.pathname)
                ...
                if (
                  ...
                  let eg =
                    ...
                    ey = eg;
                  j.hasBasePath(ey) && (ey = x.removeBasePath(ey));
              ...
              if ("type" in ep) {
                ...
                return (
                  X({ url: ep.destination, router: l }), new Promise(() => {})
                );
              }
              let { error: eP, props: eb, __N_SSG: eS, __N_SSP: ew } = ep,
                eE = ep.Component;
              ...
              if ((eS || ew) && eb) {
                if (eb.pageProps && eb.pageProps.__N_REDIRECT) {
                  o.locale = !1;
                  let eC = eb.pageProps.__N_REDIRECT;
                  if (
                    eC.startsWith("/") &&
                    !1 !== eb.pageProps.__N_REDIRECT_BASE_PATH
                  ) {
                    let ej = y.parseRelativeUrl(eC);
                    ej.pathname = U(ej.pathname, n);
                    let { url: eO, as: eR } = F(l, eC, eC);
                    return l.change(e, eO, eR, o);
                  }
                  return X({ url: eC, router: l }), new Promise(() => {});
                }
                if (((v.isPreview = !!eb.__N_PREVIEW), eb.notFound === W)) {
                  let eM;
                  try {
              ...
              let eL =
                  o.shallow && v.route === (null != (ef = ep.route) ? ef : Q),
                eT = null != (eh = o.scroll) ? eh : !o._h && !eL,
                eI = a({}, v, {
                  route: Q,
                  pathname: V,
                  query: $,
                ...
                ek =
                  o._h && !eN && !O && !Z && M.compareRouterStates(eI, l.state);
              if (!ek) {
                if (
                  (yield l.set(eI, ep, eN).catch((e) => {
                    if (e.cancelled) eP = eP || e;
                    else throw e;
                  }),
                  eP)
                )
                  throw (h || Y.events.emit("routeChangeError", eP, q, H), eP);
                h || Y.events.emit("routeChangeComplete", r, H),
          ...
          return n(function* () {
            ...
            try {
              ...
              if (
                ...
                let M = s.removeTrailingSlash(R.effect.resolvedHref),
                ...
                if (
                  ...
                  (l = x.removeBasePath(
                    h.normalizeLocalePath(R.effect.parsedAs.pathname, v.locales)
                      .pathname
                  )),
                  (C = v.components[e]),
              ...
              return v.handleRouteInfoError(d.getProperError(D), r, o, i, u);
            }
          })();
        }
        set(e, t, r) {
        ...
        prefetch(e) {
          ...
          return n(function* () {
            ...
            let n = y.parseRelativeUrl(e),
              ...
              h = yield T({ asPath: t, locale: f, router: o });
        ...
        (q = function (e, t) {
          ...
          var n,
            ...
            o = function (e) {
              ...
              var t = H[Math.min(H.length - 1, Math.floor(B() / 50))];
              t &&
                t.latency !== a.value &&
