  ...
  const books = [
    {
      ...
      genre: "Romance",
      status: "Published",
      coverColor: "from-indigo-400 via-purple-500 to-blue-500",
    ...
    },
    {
      ...
      genre: "Romance",
      status: "Early Access",
      coverColor: "from-indigo-400 via-indigo-500 to-purple-600",
      readLink: "#",
      requestLink: "#"
    }
  ];
      ...
      <section ref={heroRef} className="relative w-full min-h-[100vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 opacity-20">
          <motion.div
            ...
            style={{
              backgroundImage: 'radial-gradient(2px 2px at 20px 30px, rgba(168,85,247,.3), transparent), radial-gradient(2px 2px at 60px 70px, rgba(99,102,241,.2), transparent), radial-gradient(1px 1px at 50px 50px, rgba(168,85,247,.25), transparent), radial-gradient(1px 1px at 130px 80px, rgba(99,102,241,.15), transparent)',
          ...
          <div className="max-w-6xl mx-auto py-20 sm:py-32">
            ...
            >
              ...
              <motion.div
                ...
                className="flex justify-center"
              >
                <div className="inline-flex items-center space-x-3 px-6 py-3 rounded-2xl border border-purple-400/50 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 backdrop-blur-xl hover:border-purple-400/80 transition-all duration-300">
                  <MapPin className="w-5 h-5 text-purple-400 flex-shrink-0" />
                  <span className="text-lg font-semibold text-[#f7f7fb]">{personalInfo.location}</span>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 bg-gradient-to-br from-purple-500 via-indigo-500 to-purple-600 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-purple-500/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16">
            {blogPosts.map((post, index) => (
              <motion.a
                ...
                className="group relative bg-[#0d0e16]/90 backdrop-blur-md rounded-2xl overflow-hidden border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-1 block mx-3 sm:mx-4"
              >
                {/* Header Section with Gradient */}
                <div className="h-40 bg-gradient-to-br from-purple-900/50 via-indigo-900/30 to-[#0d0e16] relative overflow-hidden">
                  {/* Decorative Pattern */}
                  ...
                  <div className="absolute top-3 left-3 z-10">
                    <span className="bg-[#0d0e16]/80 backdrop-blur-sm text-purple-300 px-3 py-1 rounded-lg text-xs font-semibold border border-purple-500/20">
                      {post.category}
              </span>
                      </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                ...
                {/* Content Section */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#f7f7fb] group-hover:text-[#9b8bff] transition-colors leading-tight mb-3 line-clamp-2">
                    {post.title}
                  </h3>
                  
                  <p className="text-[#a8a9c3] leading-relaxed mb-5 line-clamp-3 text-sm">
                    {post.excerpt}
                  </p>
                  
                  {/* Social Actions */}
                  <div className="flex items-center justify-end pt-4 border-t border-purple-500/15 mb-4" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center gap-2">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        className="p-2 text-gray-400 hover:text-sky-400 hover:bg-sky-500/10 rounded-lg transition-all duration-200"
                      ...
                      <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        className="p-2 text-gray-400 hover:text-[#a8a9c3] hover:bg-[#151725] rounded-lg transition-all duration-200"
                        title="Bookmark"
                        onClick={(e) => e.stopPropagation()}
                      >
                  ...
                  {/* Read More Button */}
                  <div className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-3 px-4 rounded-xl font-semibold text-sm group-hover:from-purple-600 group-hover:to-indigo-600 transition-all duration-300">
            ...
            {books.map((book, index) => (
              ...
              >
                ...
                <div className="text-center mb-8">
                  <div className={`w-64 h-80 mx-auto bg-gradient-to-br ${book.coverColor} rounded-2xl flex items-center justify-center mb-6 relative overflow-hidden shadow-2xl`}>
                    ...
                    <div className="relative z-10 text-center p-6">
                      <p className="text-white/85 text-sm italic mb-4 leading-relaxed">{book.quote}</p>
                      <h3 className="text-white text-2xl font-bold mb-2">{book.title}</h3>
                      <p className="text-white/80 text-lg">{book.subtitle}</p>
                      <p className="text-white/65 text-sm mt-3">A Novel by Meet Patel</p>
                </div>
                </div>
                  </div>
                ...
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-[#f7f7fb] text-center">{book.title}</h3>
                  
                  <p className="text-[#a8a9c3] leading-relaxed text-center">
                    {book.description}
                  </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {achievements.map((achievement) => (
                  <div key={achievement.title} className="apple-glass rounded-xl p-4">
                    ...
                    <h4 className="text-[#f7f7fb] font-semibold text-sm mb-1">{achievement.title}</h4>
                    <p className="text-[#70728d] text-xs">{achievement.description}</p>
                  </div>
                ))}
              </div>
                <motion.a
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[#f7f7fb] font-semibold text-sm mb-2">Name *</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-[#f7f7fb] font-semibold text-sm mb-2">Email *</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div>
                <label className="block text-[#f7f7fb] font-semibold text-sm mb-2">WhatsApp Number</label>
                <div className="flex gap-2">
                  <div className="relative">
                    <select
                      ...
                      onChange={handleInputChange}
                      className="bg-[#151725] border border-purple-500/20 rounded-xl p-4 text-[#f7f7fb] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-400 transition-all duration-300 appearance-none cursor-pointer min-w-[140px] pr-10"
                    >
                      {countryCodes.map((country) => (
                        <option key={country.code} value={country.code} className="bg-[#151725] text-[#f7f7fb]">
              ...
              <div>
                <label className="block text-[#f7f7fb] font-semibold text-sm mb-2">Subject *</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div>
                <label className="block text-[#f7f7fb] font-semibold text-sm mb-2">Message *</label>
                <textarea
                  name="message"
              ...
              <motion.button
                ...
                className={`group relative w-full py-5 px-8 rounded-2xl font-bold transition-all duration-300 flex items-center justify-center space-x-3 text-lg overflow-hidden text-white ${
                  isSubmitting
                    ...
                    : 'bg-gradient-to-r from-purple-500 via-indigo-500 to-purple-600 hover:from-purple-600 hover:via-indigo-600 hover:to-purple-700 shadow-xl hover:shadow-2xl hover:shadow-purple-500/30'
                }`}
              >
                {!isSubmitting && (
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.div
                ...
                whileInView={{ scale: 1 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                className="w-20 h-20 bg-gradient-to-r from-purple-500 via-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl"
              >
