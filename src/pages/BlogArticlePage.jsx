...
import {
  ...
  Twitter, Linkedin, Facebook, Copy, Eye, BookOpen,
  ArrowLeft, ArrowRight, X,
} from 'lucide-react';
import { getArticleBySlug, getRelatedArticles, getPublishedArticles, incrementViews } from '../lib/articleService';
    ...
    <>
      ...
      <style>{`
        ...
        * { -webkit-font-smoothing: antialiased; }
        ...
        .article-body h1 { font-size: clamp(28px, 4vw, 40px); }
        .article-body h2 { font-size: clamp(22px, 3vw, 30px); border-bottom: 1px solid rgba(255,255,255,0.07); padding-bottom: 10px; }
        .article-body h3 { font-size: clamp(18px, 2.5vw, 24px); }
        .article-body p  { color: #8e8ea0; line-height: 1.8; margin: 0 0 1.25rem; font-size: clamp(15px, 1.5vw, 17px); }
        .article-body ul,
        .article-body ol { color: #8e8ea0; padding-left: 1.5rem; margin: 0 0 1.25rem; line-height: 1.8; font-size: clamp(15px, 1.5vw, 17px); }
        .article-body li  { margin-bottom: 0.4rem; }
        .article-body a   { color: #8b5cf6; text-decoration: underline; text-underline-offset: 3px; }
        ...
        .article-body pre code { padding: 0; border: none; background: none; }
        .article-body pre { padding: 16px 20px; overflow-x: auto; margin: 1.25rem 0; }
        .article-body strong { color: #f5f5f7; font-weight: 600; }
        .article-body em { color: #8e8ea0; }
        .article-body hr { border: none; border-top: 1px solid rgba(255,255,255,0.07); margin: 2rem 0; }
      ...
      <div style={{ background: C.bg, minHeight: '100vh', color: C.primary, fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, sans-serif' }}>
        ...
        <div style={{ position: 'fixed', top: 64, left: 0, right: 0, height: 2, background: 'rgba(255,255,255,0.06)', zIndex: 9998 }}>
          <motion.div
        ...
        {/* ── Article header ────────────────────────────────────────────────── */}
        <section style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(100px, 13vw, 160px) 24px clamp(48px, 7vw, 80px)' }}>
          ...
          <div style={{ position: 'relative', maxWidth: 800, margin: '0 auto' }}>
            ...
            {/* Category badge */}
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 }} style={{ marginBottom: 20 }}>
              <span style={{
            ...
            >
              {[
                ...
                { icon: Clock, text: article.readTime },
                { icon: Eye, text: `${article.views?.toLocaleString()} views` },
              ].map(({ icon: Icon, text }) => (
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                background:     'linear-gradient(135deg, #111118 0%, #16161f 40%, rgba(139,92,246,0.15) 100%)',
                display:        'flex',
                alignItems:     'center',
                ...
                <div style={{
                  width: 64, height: 64, background: C.violetDim,
                  border: `1px solid ${C.violetBorder}`,
                  borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center',
                  position: 'relative',
                }}>
                  <BookOpen size={28} color={C.violet} />
                </div>
              </div>
              ...
              <div style={{ padding: 'clamp(32px, 5vw, 56px)' }}>
                ...
                {article.ai_summary && (
                  ...
                  >
                    ...
                    <p style={{ margin: 0, fontSize: 15, color: C.secondary, lineHeight: 1.7 }}>
                      {article.ai_summary}
                    </p>
                  </div>
                )}
                      ...
                      {article.citations.filter(c => c.url && c.title).map((c, i) => (
                        <li key={i} style={{ marginBottom: 6 }}>
                          <a
                            ...
                            style={{ fontSize: 13, color: C.violet, textDecoration: 'underline', textUnderlineOffset: 3 }}
                          >
                            {c.title}
                          </a>
                        </li>
        ...
        {relatedArticles.length > 0 && (
          <section style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px 80px' }}>
            <div style={{ marginBottom: 32 }}>
              ...
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 700, color: C.primary, margin: '8px 0 0', letterSpacing: '-0.02em' }}>
                Related Articles
              </h2>
            </div>
        ...
        <section style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px 100px' }}>
          ...
          >
            ...
            <div style={{ position: 'absolute', top: 0, left: '15%', right: '15%', height: '1px', background: 'linear-gradient(90deg, transparent, rgba(139,92,246,0.5), transparent)' }} />
            <div style={{ position: 'relative' }}>
              <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 800, color: C.primary, margin: '0 0 12px', letterSpacing: '-0.03em' }}>
