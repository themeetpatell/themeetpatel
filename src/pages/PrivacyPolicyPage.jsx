        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-center mb-6">
              <Shield className="w-10 h-10 sm:w-12 sm:h-12 text-cyan-400 mb-4 sm:mb-0 sm:mr-4" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          <div className="bg-white/5 rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/10">
            ...
            <div className="text-white/80 space-y-4">
              <p>We use cookies and similar technologies to enhance your browsing experience. You can control cookie settings through your browser preferences. For more details, see our <Link to="/cookie-policy" className="text-cyan-400 hover:text-cyan-300">Cookie Policy</Link>.</p>
              </div>
            ...
            <div className="mt-8 p-4 sm:p-6 bg-cyan-500/10 rounded-xl border border-cyan-500/20">
