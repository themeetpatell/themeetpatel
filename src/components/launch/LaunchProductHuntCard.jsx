...
/**
 * Floating, dismissible Product Hunt card pinned to the bottom-left on desktop
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'linear-gradient(150deg, rgba(17,16,24,0.95) 0%, rgba(22,15,18,0.95) 100%)',
          boxShadow: `0 24px 60px -18px ${LAUNCH.phOrange}55, 0 0 0 1px ${LAUNCH.phOrange}1f inset`,
        }}
      >
        {/* soft orange radial */}
        <span
          ...
          style={{
            background: `radial-gradient(120% 80% at 0% 0%, ${LAUNCH.phOrange}1f 0%, transparent 55%)`,
          }}
        />
        ...
        <a
          ...
          style={{
            ...
            boxShadow: `0 10px 24px -8px ${LAUNCH.phOrange}aa`,
          }}
        >
...
export default LaunchProductHuntCard;
